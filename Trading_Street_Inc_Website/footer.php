...
<div style="background-color: #F8FEFF;" class="container-fluid">
  ...
  <div class="row">
    <div class="col d-flex justify-content-center p-5">
      <h5 style="font-family:'Segoe UI', Tahoma, Geneva, Verdana, sans-serif;font-weight:bolder;" class="text-uppercase text-dark">Trading <strong class="info-color">Street Inc</strong></h5>
    </div>
  </div>
  <div class="row">
    <div class="col">
              ...
              <div class="row">
                <div class="cover">
                  ...
                  <form class="flex-form">
                    <input class="i" type="search" placeholder="Where do you want to go?">
                    <input style="border-top-right-radius: 40px !important; border-bottom-right-radius: 40px !important;" type="submit" value="Search">
                  </form>
