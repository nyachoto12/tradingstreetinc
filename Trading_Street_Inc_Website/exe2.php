...
<head>
    ...
    <title>Latest News | Trading Street Inc</title>
    <!--Bootsrap 4 CDN-->
            ...
            <div style=" background-color: rgba(0, 0, 0, 0.8);font-size: small;" class="text-white p-3">
                ...
                <div class="cond-in">
                    ...
                    <strong>
                        ...
                        <h6 class="text-white display-4 cond-header" style="font-weight: bold;">News</h6>
    ...
    <div class="container-fluid">
        <div class="row no-gutters p-0 m-0">
            ...
            <?php
                ...
                $url = "https://newsapi.org/v2/everything?q=trade-africa&from=$a&to=$n&sortBy=date&apiKey=d1ab4131a93b4ca3bcda10cd56bbf08b";
