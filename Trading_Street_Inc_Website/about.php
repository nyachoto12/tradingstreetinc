...
<head>
    ...
    <style>
        ...
        .picture-about2 {
            background: url(./images/swift_images_aboutus_partners.jpg);
            background-size: cover;
            background-position: center;
            background-repeat: no-repeat;
            background-attachment: relative;
        ...
        .about-picture {
            background: url(./images/9c7852c2cc7817668bfaa7c24458cd49.jpeg);
            background-size: cover;
            background-position: center;
            background-repeat: no-repeat;
            background-attachment: fixed;
    ...
    <div class="container-fluid p-5">
        <div class="row pl-5 pr-5 pt-5">
            ...
            <div class="col-sm col-md col-lg-5 pb-3">
                ...
                <p class=" d-flex justify-content-end">
                    <a onclick="myFunction()" id="myBtn" class="btn" style="text-decoration: underline; color: #17A2B8 !important;">Read more</a>
                </p>
        ...
        <div class="row pl-5 pr-5 pt-5">
            ...
            <div class="col-sm col-md col-lg-5 pb-3">
                ...
                <p class=" d-flex justify-content-end">
                    <a onclick="myFunction2()" id="myBtn2" class="btn" style="text-decoration: underline; color: #17A2B8 !important;">Read more</a>
                </p>
