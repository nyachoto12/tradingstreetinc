                    ...
                    <div class="row p-5">
                        <div class="col-sm col-md col-lg p-4 ">
                            ...
                            <form action="mail.php" method="POST " class="">
                                ...
                                <div>
                                    <div class="form-group p-3 pb-0"><input type="text " class="form-control text-gray rounded-0 " name="phone " aria-describedby=" phone " placeholder="Subject"><span class="error pr-2 text-danger pl-2"></span></div>
                                    <div class="form-group p-3 pt-0"><textarea name="message " id="message " cols="100 " rows="4 " class="form-control  rounded-0 text-gray " placeholder="Your Message"></textarea><span class="error pr-2 text-danger pl-2"></span></div>
                                    <div class="form-group "><button type="submit " name="submit " class="btn rounded-0 text-uppercase w-50 text-light info-bg " style="font-size: 20px; margin-left: 10px; ">Send</button></div>
                                </div>
                            </form>
                        </div>
                    </div>
